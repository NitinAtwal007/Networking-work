Router flooding is technique in Computer networks where the routers propagate the information to all the other routers in the network by sending the information to their adjacantrouters and so on .
